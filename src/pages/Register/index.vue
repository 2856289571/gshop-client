  ...
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="controls">
        ...
        <input name="isChecked" type="checkbox" v-model="isChecked"
...
<script>
  export default {
     ...
     */
      async register(){
        // vee-validate对所有表单项统一验证
        const success = await this.$validator.validateAll() // 对所有表单项进行验证
        
        if(success){
          let {phone,code,password,surePassword,nickName} = this
          // 发送注册请求
          try {
            await this.$store.dispatch('register',{phone,code,password,surePassword,nickName})
            alert('注册成功')
