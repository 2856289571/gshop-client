          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                @click="setSpuSaleValue(spuSaleAttrValue,spuSaleAttr.spuSaleAttrValueList)"
            ...
            <div class="cartWrap">
              <div class="controls">
                ...
                href="javascript:" 
                class="mins"
                @click="skuNum = skuNum >= 1 ? skuNum -- : skuNum = 1"
                >-</a>
              </div>
              <div class="add">
  ...
  export default {
    ...
    methods:{
      /* 
        点击销售属性时排他处理
      */
      setSpuSaleValue(spuSaleAttrValue,spuSaleAttrValueList){
        // 获得所有列表项，遍历列表项全部设置为未选
    ...
    computed:{
      ...
      /* 
        左侧商品图片列表
          像这种a.b.c读取属性的，最好都将它映射为d=a.b.c,并且对可能返回undefined的值进行处理，避免报错
      */
      skuImageList(){
